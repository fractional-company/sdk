...
const { Base, Buyout, Migration } = Modules;
const { Mainnet, Rinkeby } = Chains;
const { Default, Nounlets } = Variants;
...
export const Proofs: {
  ...
  // Base Vault + Buyout + Migration
  [`${Base}_${Buyout}_${Migration}`]: {
    [Default]: {
      [Mainnet]: [],
      [Rinkeby]: [
        [
